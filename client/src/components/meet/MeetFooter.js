    ...
    <LinearGradient
      ...
      <View style={footerStyles.iconContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => toggleVideo()}>
          {videoOn ? (
            <Video color={getIconColor(videoOn)} size={RFValue(15)} />
          ) : (
            <VideoOff color={getIconColor(videoOn)} size={RFValue(15)} />
          )}
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => toggleMic()}>
          {micOn ? (
            <Mic color={getIconColor(micOn)} size={RFValue(15)} />
          ) : (
            <MicOff color={getIconColor(micOn)} size={RFValue(15)} />
          )}
        </TouchableOpacity>

        <TouchableOpacity style={footerStyles.iconButton}>
          <Hand color="white" size={RFValue(15)} />
        </TouchableOpacity>

        <TouchableOpacity style={footerStyles.iconButton}>
          <MoreVertical color="white" size={RFValue(15)} />
        </TouchableOpacity>
      </View>
    </LinearGradient>
  );
